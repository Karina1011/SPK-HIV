            ...
            <div class="col-lg-12">
              <fieldset>
                ...
                <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" required>
                  <option value="Laki-laki" {{ (auth()->user()->pasien->jenis_kelamin ?? '') === 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                  <option value="Perempuan" {{ (auth()->user()->pasien->jenis_kelamin ?? '') === 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                </select>
              </fieldset>
            </div>
            <div class="col-lg-12">
